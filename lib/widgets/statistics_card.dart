          ...
          children: [
            ...
            LinearProgressIndicator(
              ...
              valueColor: AlwaysStoppedAnimation<Color>(
                successRate >= 0.7 ? Colors.green : Colors.orange,
              ),
            ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: currentStreak > 0 ? Colors.orange.withOpacity(0.1) : Colors.grey.withOpacity(0.1),
                borderRadius: BorderRadius.circular(8),
                border: Border.all(
                  color: currentStreak > 0 ? Colors.orange.withOpacity(0.3) : Colors.grey.withOpacity(0.3),
                ),
              ),
              child: Column(
                children: [
