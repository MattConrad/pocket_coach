...
const ChatMessageSchema = CollectionSchema(
  ...
  properties: {
    r'coachExpression': PropertySchema(
      id: 0,
      name: r'coachExpression',
      type: IsarType.byte,
      enumMap: _ChatMessagecoachExpressionEnumValueMap,
    ),
    r'coachPersonaId': PropertySchema(
      id: 1,
      name: r'coachPersonaId',
...
int _chatMessageEstimateSize(
  ...
  bytesCount += 3 + object.coachPersonaId.length * 3;
...
void _chatMessageSerialize(
  ...
  writer.writeByte(offsets[0], object.coachExpression.index);
  writer.writeString(offsets[1], object.coachPersonaId);
...
ChatMessage _chatMessageDeserialize(
  ...
  object.coachExpression = _ChatMessagecoachExpressionValueEnumMap[
          reader.readByteOrNull(offsets[0])] ??
      CoachExpression.defaultExpression;
  object.coachPersonaId = reader.readString(offsets[1]);
  object.id = id;
  object.sender =
...
P _chatMessageDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (_ChatMessagecoachExpressionValueEnumMap[
              reader.readByteOrNull(offset)] ??
          CoachExpression.defaultExpression) as P;
    case 1:
...
const _ChatMessagecoachExpressionEnumValueMap = {
  'defaultExpression': 0,
  'happy': 1,
  'disappointed': 2,
  'surprised': 3,
};
const _ChatMessagecoachExpressionValueEnumMap = {
  0: CoachExpression.defaultExpression,
  1: CoachExpression.happy,
  2: CoachExpression.disappointed,
  3: CoachExpression.surprised,
};
...
const _ChatMessagesenderValueEnumMap = {
  0: MessageSender.user,
  1: MessageSender.coach,
};
...
extension ChatMessageQueryWhereSort
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterWhere> anyTaskId() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQueryWhere
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterWhereClause> taskIdIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterWhereClause> taskIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterWhereClause> taskIdEqualTo(
      int? taskId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'taskId',
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterWhereClause> taskIdNotEqualTo(
      int? taskId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterWhereClause> taskIdGreaterThan(
    int? taskId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterWhereClause> taskIdLessThan(
    int? taskId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterWhereClause> taskIdBetween(
    int? lowerTaskId,
    int? upperTaskId, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ChatMessageQueryFilter
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      coachExpressionEqualTo(CoachExpression value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'coachExpression',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      coachExpressionGreaterThan(
    CoachExpression value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      coachExpressionBetween(
    CoachExpression lower,
    CoachExpression upper, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      coachPersonaIdEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'coachPersonaId',
        value: value,
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      coachPersonaIdContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      coachPersonaIdMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition> taskIdIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition> taskIdEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'taskId',
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition> taskIdLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition> taskIdBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ChatMessageQuerySortBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByCoachExpression() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'coachExpression', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy>
      sortByCoachExpressionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'coachExpression', Sort.desc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByCoachPersonaId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'coachPersonaId', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy>
      sortByCoachPersonaIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'coachPersonaId', Sort.desc);
    });
  }
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByTaskId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'taskId', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByTaskIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQuerySortThenBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByCoachExpression() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'coachExpression', Sort.asc);
    });
  }
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy>
      thenByCoachExpressionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'coachExpression', Sort.desc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByCoachPersonaId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'coachPersonaId', Sort.asc);
    });
  }
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByTaskId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'taskId', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByTaskIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'taskId', Sort.desc);
    });
  }
...
extension ChatMessageQueryWhereDistinct
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct>
      distinctByCoachExpression() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'coachExpression');
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByCoachPersonaId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'coachPersonaId',
          caseSensitive: caseSensitive);
    });
  }
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByTaskId() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQueryProperty
  ...
  QueryBuilder<ChatMessage, CoachExpression, QQueryOperations>
      coachExpressionProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'coachExpression');
    });
  }

  QueryBuilder<ChatMessage, String, QQueryOperations> coachPersonaIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'coachPersonaId');
    });
  }

  QueryBuilder<ChatMessage, MessageSender, QQueryOperations> senderProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'sender');
    });
  }

  QueryBuilder<ChatMessage, int?, QQueryOperations> taskIdProperty() {
    return QueryBuilder.apply(this, (query) {
