...
class TTSService {
  ...
  static Future<void> _speakWithPremiumTTS(String text, String apiKey, CoachPersonaId? coachPersona) async {
  ...
  static Map<CoachPersonaId, Map<String, dynamic>> get voiceConfigs => {
    ...
    CoachPersonaId.john: {'pitch': 1.0, 'rate': 0.5, 'volume': 0.95},
    CoachPersonaId.callum: {'pitch': 1.3, 'rate': 0.7, 'volume': 1.0},
  };
}
